...
const BottomTabNavigator = () => {
  return (
    ...
    screenOptions={{
      ...
      <Tab.Screen name="BlogStack" component={BlogStackNavigator} 
      options={{tabBarIcon: ({focused}) => (
          <FontAwesome5 name="blog" size={25} color={focused ? '#551E18' : '#000'}/>
      ),
    tabBarLabel: () => <Text style={styles.tabBarLabel}>Blog</Text>}}/>

      <Tab.Screen name="NewAppointmentStack" component={NewAppointmentStackNavigator} 
        options={{tabBarIcon: ({focused}) => (
            <FontAwesome5 name="plus" size={40} style={{
                position: 'absolute',
                bottom: 5,
            }} 
      ...
      <Tab.Screen name="ProfileStack" component={ProfileStackNavigator} 
            options={{tabBarIcon: ({focused}) => (
                <Ionicons name="person" size={25} color={focused ? '#551E18' : '#000'}/>
            ),
