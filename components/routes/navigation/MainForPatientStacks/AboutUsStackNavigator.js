...
const AboutUsC = () => (
  <ScrollView style={styles.scrollview}>
    <View style={styles.aboutUs}>
      ...
      <Text style={styles.smallText}>
        You can easily schedule an appointment, using this application, so there
        is no need to spend a lot of time in phone calls for this.
      </Text>
      <Text style={styles.smallText}>
        If you have any problem using this app or you want to report a bug, you
        can send an email to one of the email adresses from the Contact menu.
      </Text>
    </View>
  </ScrollView>
);
