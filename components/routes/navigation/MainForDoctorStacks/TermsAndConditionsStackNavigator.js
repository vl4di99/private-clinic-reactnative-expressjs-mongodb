...
const TermsAndConditionsScreen = () => (
  <ScrollView style={style.scrollview}>
    ...
    <Text style={style.texts2}>
      ...
      continue to use PrivateClinic if you do not agree to take all of the terms
      ...
      on this application and compliant to the Company’s terms and conditions.
    ...
    <Text style={style.texts2}>
      ...
      content from PrivateClinic This Agreement shall begin on the date hereof.
      Our Terms and Conditions were created with the help of the Terms And
      Conditions Template. Parts of this application offer an opportunity for
      users to post and exchange opinions and information in certain areas of
      the application. PrivateClinic does not filter, edit, publish or review
      Comments prior to their presence on the application. Comments do not
      reflect the views and opinions of PrivateClinic,its agents and/or
      ...
      PrivateClinic shall not be liable for the Comments or for any liability,
      damages or expenses caused and/or suffered as a result of any use of
      and/or posting of and/or appearance of the Comments on this application.
      PrivateClinic reserves the right to monitor all Comments and to remove any
      ...
      entitled to post the Comments on our application and have all necessary
      ...
      activity. You hereby grant PrivateClinic a non-exclusive license to use,
    ...
    <Text style={style.texts2}>
      ...
      manner as they hyperlink to the Applications of other listed businesses;
      ...
      which may not hyperlink to our Application. These organizations may link
      to our home page, to publications or to other Application information so
      ...
      visibility of the hyperlink compensates the absence of PrivateClinic; and
      (d) the link is in the context of general resource information. These
      ...
      our application, you must inform us by sending an e-mail to PrivateClinic.
      ...
      link to our Application, and a list of the URLs on our site to which you
      would like to link. Wait 2-3 weeks for a response. Approved organizations
      may hyperlink to our application as follows: By use of our corporate name;
      or By use of the uniform resource locator being linked to; or By use of
      any other description of our Application being linked to that makes sense
      within the context and format of content on the linking party’s site. No
      use of PrivateClinic's logo or other artwork will be allowed for linking
    ...
    <Text style={style.texts2}>
      ...
      or your liability for death or personal injury; limit or exclude our or
      your liability for fraud or fraudulent misrepresentation; limit any of our
