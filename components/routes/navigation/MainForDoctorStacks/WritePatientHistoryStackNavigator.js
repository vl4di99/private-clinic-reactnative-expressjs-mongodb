...
const WritePatientHistory = () => {
    ...
    const saveHistory = async () => {
        ...
        await Client.post("/medicalHistory",{patient, history, doctor, department, date})
            .then((response)=>{Alert.alert("Saved successfully",response.data.message)})
            .catch((error)=>{Alert.alert("Error", "An error occured. Please contact the administrator.");
        ...
        <View style={styles.aboutUs}>
            <View>
                ...
                <TextInput
                    ...
                    style={[styles.text_input, {justifyContent: 'center', color: "black"}]}
...
const WritePatientHistoryStackNavigator = () => {
    return (
        ...
        >
            <Stack.Screen name="WritePatientHistory" component={WritePatientHistory} />
        </Stack.Navigator>
    );
};
