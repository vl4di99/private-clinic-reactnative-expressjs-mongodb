...
import {
    View, Text, ScrollView, StyleSheet, Dimensions, TextInput, Button, Alert, Image, TouchableOpacity, ActivityIndicator
} from "react-native";
...
const CreateBlogPost = () => {
        ...
        if (imageOK) {
            ...
            const saveToMongo = (imgURL) => {
                ...
                if (img !== '') {
                    ...
                    Alert.alert('Image', 'Image uploaded, but failed to get link. Please contact administrator!');
                }
            }
        } else {
    ...
    return (<View>
        <View>
            ...
            <TextInput placeholder="Author" style={styles.text_input}
                       onChangeText={(event) => setAuthorText(event)}/>
            <TextInput placeholder="Content" style={styles.textarea_input} NumberOfLines={15}
...
const styles = StyleSheet.create({
    text_input: {
        width: WIDTH * 0.8, borderWidth: 1, borderRadius: 15, borderColor: "turquoise", alignSelf: "center", margin: 10
    }, textarea_input: {
        width: WIDTH * 0.8, borderWidth: 1, borderRadius: 15, borderColor: "red", alignSelf: "center", height: 200
    }, saveButton: {
        height: HEIGHT * 0.05,
        width: WIDTH * 0.25,
        ...
        fontSize: 16, textAlign: "center", fontWeight: "bold",
    }, pickImageButton: {
        marginTop: 10,
        width: WIDTH * 0.5,
        height: HEIGHT * 0.05,
